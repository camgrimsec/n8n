...
/**
 * Guards constrained entry points (e.g. the DI-less
 * `@n8n/backend-network/transport` subpath) by walking their runtime import
 * graph and asserting no forbidden package — DI, config, backend-common — is
 * reachable, so DI-less callers don't drag the full service into their bundle.
 */
