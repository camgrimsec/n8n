...
// eslint-disable-next-line n8n-local-rules/no-uncentralized-http -- proxy URL is resolved via the factory (resolveProxyUrl); the undici fetch dispatcher has no centralized factory yet.
